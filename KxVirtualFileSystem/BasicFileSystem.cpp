...
namespace KxVFS
{
	...
	{
		KxVFS_DebugPrint(TEXT("%s"), TEXT(__FUNCTION__));
	...
	{
		KxVFS_DebugPrint(TEXT("%s: \"%s\""), TEXT(__FUNCTION__), eventInfo->FileName);
	...
	{
		KxVFS_DebugPrint(TEXT("%s: \"%s\", DeleteOnClose: %d"), TEXT(__FUNCTION__), eventInfo->FileName, (int)eventInfo->DokanFileInfo->DeleteOnClose);
	...
	{
		KxVFS_DebugPrint(TEXT("%s: \"%s\" -> \"%s\""), TEXT(__FUNCTION__), eventInfo->FileName, eventInfo->NewFileName);
